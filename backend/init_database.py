...
def init_database():
    ...
    try:
        ...
        emotion_questions = [
            # Anxiety
            ("anxiety", "What specific thoughts or situations triggered your anxiety today?"),
            ("anxiety", "What physical sensations did you notice when feeling anxious?"),
        ...
        # Add quotes
        quotes = [
            ("anxiety", "You are braver than you believe, stronger than you seem, and smarter than you think.", "A.A. Milne"),
            ("anxiety", "Nothing can bring you peace but yourself.", "Ralph Waldo Emerson"),
            ...
            ("stress", "You have been assigned this mountain to show others it can be moved.", "Mel Robbins"),
            ...
            ("happiness", "The secret of being happy is accepting where you are in life.", "Unknown"),
            ("anger", "For every minute you are angry you lose sixty seconds of happiness.", "Ralph Waldo Emerson"),
